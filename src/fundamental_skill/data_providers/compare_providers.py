...
def run_provider_comparison(
    *,
    ...
    if real_token_smoke:
        raise ProviderComparisonError("real-token smoke is not implemented in Phase 4 minimal dry-run")
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    parser.add_argument("--real-token-smoke", action="store_true", help="Fail closed in Phase 4 minimal")
