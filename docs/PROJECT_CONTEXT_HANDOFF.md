...
implementation is accepted; and the three-sample HTML presentation baseline is
...
HTML acceptance summary. The HTML renderer implementation is accepted, the
three-sample HTML validation passed, and the HTML presentation layer baseline
is frozen.
...
`124 passed`, and regression `passed=47 failed=0 total=47`.
