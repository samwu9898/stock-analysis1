...
acceptance is complete for `600406`, `002371`, and `002050`, and HTML
presentation layer design is recorded in
`docs/FUNDAMENTAL_RESEARCH_REPORT_V1_HTML_PRESENTATION_DESIGN.md`. The accepted
...
HTML renderer implementation, not promote rules, validator, fixture promotion,
Tushare primary, live provider report, or another smoke.
...
- Current Research Report V1 presentation step: proceed to HTML renderer
  implementation. HTML must consume Markdown / presentation-layer
...
Next recommended stage: HTML renderer implementation. Promote rules, validator,
fixture promotion, live provider report, official parser / CNInfo, and Tushare
